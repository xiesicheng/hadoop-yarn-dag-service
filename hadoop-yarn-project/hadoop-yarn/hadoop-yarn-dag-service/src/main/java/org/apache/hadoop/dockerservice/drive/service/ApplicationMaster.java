...
//                LOG.info(stringBuilder2.toString());
                ...
                for (Map.Entry<String,Double> entry : scoreMap.entrySet()){
                    ...
                    ContainerId containerId = service2CIdMap.get(serviceName);
                    if ( containerId == null ){
                      stringBuilder.delete(0,stringBuilder.length());
                      stringBuilder.append("junqing xiao : scoreMap-->{<containerId = null,service = ")
                                   .append(serviceName).append(">");
                      list.clear();
                      break;
                    }else {
                      stringBuilder.append("<").append(serviceName).append(":").append(entry.getValue()).append(">,");
                      list.add(ContainerScore.newInstance(containerId,entry.getValue()));
                    }
                }
