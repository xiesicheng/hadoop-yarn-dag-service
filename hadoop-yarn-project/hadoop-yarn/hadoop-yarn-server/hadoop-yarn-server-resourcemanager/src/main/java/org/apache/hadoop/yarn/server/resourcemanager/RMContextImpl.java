...
public class RMContextImpl implements RMContext {
   ...
   * */
  @Override
  public ConcurrentMap<NodeId, Set<ServicePort>> getNMServicePorts() {
    return this.activeServiceContext.getNMServicePorts();
  }

  @Override
  public void updateNMServicePorts(NodeId nodeId, ServicePort SP) {
    this.activeServiceContext.updateNMServicePorts(nodeId, SP);
  }
